...
(function () {
  ...
  window.SAANS_CONTENT = {
    ...
    resources: {
      books: {
        ur: [
          { title: 'الن اکار کا آسان طریقہ', author: 'ایلن کار', url: 'https://www.goodreads.com/book/show/10833606-the-easy-way-to-stop-smoking' },
          { title: 'WHO — تمباکو چھوڑنے کی گائیڈ', author: 'WHO', url: 'https://www.who.int/publications/i/item/9789241514929' },
          { title: 'This Naked Mind', author: 'Annie Grace', url: 'https://www.thisnakedmind.com/' },
          { title: 'The Smoke Free Formula', author: 'Dr Robert West', url: 'https://www.goodreads.com/book/show/17847683-the-smoke-free-formula' },
        ],
        en: [
          { title: 'The Easy Way to Stop Smoking', author: 'Allen Carr', url: 'https://www.goodreads.com/book/show/10833606-the-easy-way-to-stop-smoking' },
          { title: 'WHO Quit Tobacco Guide', author: 'WHO', url: 'https://www.who.int/publications/i/item/9789241514929' },
          { title: 'This Naked Mind', author: 'Annie Grace', url: 'https://www.thisnakedmind.com/' },
          { title: 'The Smoke Free Formula', author: 'Dr Robert West', url: 'https://www.goodreads.com/book/show/17847683-the-smoke-free-formula' },
          { title: 'Allen Carr\'s Easy Way', author: 'Allen Carr', url: 'https://www.allencarr.com/' },
          { title: 'Quit Genius App', author: 'Quit Genius', url: 'https://www.quitgenius.com/' },
        ],
      },
      websites: {
        ur: [
          { title: 'WHO — تمباکو کنٹرول', url: 'https://www.who.int/teams/health-promotion/tobacco-control' },
          { title: 'Smokefree.gov', url: 'https://smokefree.gov/' },
          { title: 'NHS — سگریٹ چھوڑیں', url: 'https://www.nhs.uk/better-health/quit-smoking/' },
          { title: 'CDC — Quit Smoking', url: 'https://www.cdc.gov/tobacco/quit_smoking/' },
          { title: 'Pakistan Tobacco Control Cell', url: 'https://tobacco.gov.pk/' },
          { title: 'Truth Initiative', url: 'https://truthinitiative.org/' },
        ],
        en: [
          ...
          { title: 'Pakistan Tobacco Control Cell', url: 'https://tobacco.gov.pk/' },
          { title: 'Truth Initiative', url: 'https://truthinitiative.org/' },
          { title: 'BecomeAnEx.org', url: 'https://www.becomeanex.org/' },
          { title: 'Mayo Clinic — Quit Smoking', url: 'https://www.mayoclinic.org/healthy-lifestyle/quit-smoking' },
        ],
      },
      videos: {
        ur: [
          { title: 'Benefits of Quitting — WHO', url: 'https://www.youtube.com/watch?v=2QHRCWGLAUg' },
          { title: 'How to Quit — CDC', url: 'https://www.youtube.com/watch?v=1C2Ma1zR1IA' },
          { title: 'Managing Cravings', url: 'https://www.youtube.com/results?search_query=smokefree.gov+cravings' },
          { title: 'NRT Explained — NHS', url: 'https://www.youtube.com/results?search_query=NHS+nicotine+replacement' },
        ],
        en: [
          { title: 'Benefits of Quitting — WHO', url: 'https://www.youtube.com/watch?v=2QHRCWGLAUg' },
          { title: 'How to Quit — CDC', url: 'https://www.youtube.com/watch?v=1C2Ma1zR1IA' },
          { title: 'Managing Cravings — Smokefree.gov', url: 'https://www.youtube.com/results?search_query=smokefree.gov+cravings' },
          { title: 'NRT Explained — NHS', url: 'https://www.youtube.com/results?search_query=NHS+nicotine+replacement' },
          { title: 'Allen Carr — Easy Way', url: 'https://www.youtube.com/results?search_query=allen+carr+stop+smoking' },
        ],
      },
    },
    ...
    nicotine: {
      ur: {
        warning: 'صرف معلومات کے لیے — بغیر ڈاکٹر کے دوا نہ لیں۔ یہ طبی مشورہ نہیں۔',
        ...
        lozenge: { title: 'نکوٹین لوزینج', pros: 'آہستہ ریلیز، ڈسکریٹ', cons: 'گلے میں جلن' },
        medsTitle: 'نسخہ دوائیں (صرف ڈاکٹر)',
        meds: [
          { name: 'Varenicline (Champix/Chantix)', desc: 'نکوٹین رسیپٹر بلاک — خواہش کم کرتا ہے۔' },
          { name: 'Bupropion (Zyban/Wellbutrin)', desc: 'خواہش اور withdrawal کم کرتا ہے۔' },
          { name: 'Cytisine (Tabex)', desc: 'کچھ ممالک میں دستیاب — ڈاکٹر کی نگرانی ضروری۔' },
          { name: 'Nortriptyline', desc: 'کبھی کبھی تجویز — ماہر مشورہ ضروری۔' },
        ],
        quiz: [
          { q: 'یہ کوئز صرف رہنمائی ہے — دوا کے لیے ڈاکٹر ضروری۔ سمجھ آ گئی؟', opts: ['ہاں، سمجھ آ گئی', 'نہیں، خود دوا لوں گا'], warning: true },
          { q: 'آپ روزانہ کتنے سگریٹ پیتے تھے؟', opts: ['10 سے کم', '10–20', '20+'] },
          { q: 'جاگتے ہی 30 منٹ میں سگریٹ؟', opts: ['ہاں', 'کبھی کبھی', 'نہیں'] },
          { q: 'پچھلی کوشش میں بڑا مسئلہ؟', opts: ['خواہش', 'ذہنی دباؤ', 'وزن'] },
          { q: 'کیا آپ ڈاکٹر سے نسخہ دوا کے بارے میں بات کر سکتے ہیں؟', opts: ['ہاں', 'شاید', 'نہیں'] },
        ],
        resultGum: 'گم اچانک خواہش پر مدد کر سکتی ہے — پہلے ڈاکٹر یا فارماسسٹ سے پوچھیں۔',
        resultPatch: 'پچ پورے دن مدد دے سکتی ہے — ڈاکٹر یا فارماسسٹ سے مشورہ کریں۔',
        resultLozenge: 'لوزینج آہستہ خواہش پر مدد — فارماسسٹ یا ڈاکٹر سے پوچھیں۔',
        resultMed: 'Varenicline یا Bupropion کے بارے میں ڈاکٹر سے بات کریں۔',
        resultWarn: 'خود دوا نہ لیں — پہلے ڈاکٹر یا سینے کی کلینک دیکھائیں۔',
      },
      en: {
        warning: 'For information only — never start medication without a doctor. Not medical advice.',
        ...
        lozenge: { title: 'Nicotine Lozenge', pros: 'Slow release, discreet', cons: 'Throat irritation' },
        medsTitle: 'Prescription medications (doctor only)',
        meds: [
          { name: 'Varenicline (Champix/Chantix)', desc: 'Blocks nicotine receptors — reduces cravings.' },
          { name: 'Bupropion (Zyban/Wellbutrin)', desc: 'Reduces cravings and withdrawal symptoms.' },
          { name: 'Cytisine (Tabex)', desc: 'Available in some countries; needs medical supervision.' },
          { name: 'Nortriptyline', desc: 'Sometimes prescribed; specialist advice required.' },
        ],
        quiz: [
          { q: 'This quiz is guidance only — medication needs a doctor. Do you understand?', opts: ['Yes, I understand', 'No, I will self-medicate'], warning: true },
          { q: 'How many cigarettes per day?', opts: ['Under 10', '10–20', '20+'] },
          { q: 'Smoke within 30 min of waking?', opts: ['Yes', 'Sometimes', 'No'] },
          { q: 'Main challenge last attempt?', opts: ['Cravings', 'Stress', 'Weight gain'] },
          { q: 'Can you consult a doctor about prescription options?', opts: ['Yes', 'Maybe', 'No'] },
        ],
        resultGum: 'Nicotine gum may suit sudden cravings. Consult a doctor or pharmacist first.',
        resultPatch: 'Nicotine patch may suit steady all-day support. Consult a doctor or pharmacist first.',
        resultLozenge: 'Lozenges may help gradual cravings. Ask a pharmacist or doctor.',
        resultMed: 'Consider talking to a doctor about varenicline or bupropion.',
        resultWarn: 'Do not self-medicate. See a doctor or chest clinic first.',
      },
    },
